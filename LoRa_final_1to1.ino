...
// ============================================================
// BLE UUIDs - SAME FOR BOTH DEVICES
// ============================================================
...
class ServerCallbacks : public BLEServerCallbacks
{
  void onConnect(BLEServer *server)
  {
    ...
    Serial.println();
    Serial.println("================================");
    Serial.println("Thanu PHONE CONNECTED");
    Serial.println("================================");
  }
...
class RxCallbacks : public BLECharacteristicCallbacks
{
  ...
  {
    // IMPORTANT:
    // Your BLE library returns Arduino String
    ...
    Serial.println();
    Serial.println("--------------------------------");
    Serial.println("PHONE 1 MESSAGE");
    Serial.println("--------------------------------");
  ...
  while (LoRaSerial.available())
  {
    ...
    else if (data == 0x03)
    {
      if (receivedMessage.length() > 0)
      {
        Serial.println();
        Serial.println("--------------------------------");
        Serial.println("MESSAGE FROM PERSON 2");
        Serial.println("--------------------------------");
        ...
        if (deviceConnected)
        {
          ...
          Serial.println("SENT TO PHONE 1");
        }
